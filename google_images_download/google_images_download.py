...
args_list = ["keywords", "keywords_from_file", "prefix_keywords", "suffix_keywords",
             ...
             "no_numbering",
             "offset", "no_download", "save_source", "silent_mode", "ignore_urls", "no_subdir"]
...
def user_input():
    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument('-is', '--save_source',
                            ...
                            type=str, required=False)
        parser.add_argument('-ns', '--no_subdir', default=False,
                            help="Allows to rename images to keywords without creating a subdirectory ", action="store_true")
...
class googleimagesdownload:
                ...
                XHR.prototype.send = function(data) {
                    ...
                    if (url.includes("/batchexecute?")) {
                        this.addEventListener(
                            "readystatechange", stateChanged, false);
                    }
                    send.call(this, data);
                };
                XHR.prototype._data = [];
    ...
    def download_image(self, image_url, image_format, main_directory, dir_name, count, print_urls, socket_timeout,
                       prefix, print_size, no_numbering, no_subdir, no_download, save_source, img_src, silent_mode, thumbnail_only,
                       format, ignore_urls):
        ...
        try:
            ...
            try:
                ...
                if prefix:
                    ...
                    prefix = ''
                # no subdir rename files to keywords
                if no_subdir:
                    if no_numbering:
        ...
        while count < limit + 1 and i < len(image_objects):
            if len(image_objects) == 0:
                ...
                download_status, download_message, return_image_name, absolute_path = self.download_image(
                    ...
                    arguments['no_numbering'], arguments['no_subdir'], arguments['no_download'], arguments['save_source'],
            ...
            for sky in suffix_keywords:  # 2.for every suffix keywords
                ...
                while i < len(search_keyword):  # 3.for every main keyword
                    ...
                    if arguments['image_directory']:
                        ...
                        dir_name = ''
                        #rename = pky + search_keyword[i] + sky
                    else:
